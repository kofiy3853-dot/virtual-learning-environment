...
export const courseApi = {
  getAll:      (params?: { search?: string; status?: string })  => api.get('/api/courses', { params }),
  getOne:      (id: string)    => api.get(`/api/courses/${id}`),
  create:      (data: Partial<Course>)     => api.post('/api/courses', data),
  ...
  createModule:(id: string, data: Partial<Module>)   => api.post(`/api/courses/${id}/modules`, data),
  ...
  createAssignment:(id: string, data: Record<string, any>)=> api.post(`/api/courses/${id}/assignments`, data),
  getQuizzes:  (id: string)    => api.get(`/api/courses/${id}/quizzes`),
  createQuiz:  (id: string, data: Record<string, any>)   => api.post(`/api/courses/${id}/quizzes`, data),
  ...
  createDiscussion:(id: string, data: { title: string; body: string })=> api.post(`/api/courses/${id}/discussions`, data),
  getLiveSessions:(id: string) => api.get(`/api/courses/${id}/live-sessions`),
  createLiveSession:(id: string, data: Record<string, any>)=>api.post(`/api/courses/${id}/live-sessions`,data),
